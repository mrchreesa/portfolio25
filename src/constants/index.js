...
export const myProjects = [
	{
		title: "KodKod AI",
		desc: "An AI-powered resume and cover letter generation platform that analyzes job descriptions and generates tailored resumes in seconds. Features a Master Profile system, Chrome extension integration, and subscription-based monetization.",
		...
		tags: [
			...
			{ id: 5, name: "TailwindCSS", path: "/assets/icons/tailwind-css.png" },
...
export const workExperiences = [
	...
	},
	{
		...
		title: "Delivered over 100 full-stack applications using the MERN stack, integrating AI-powered features and RESTful APIs to meet diverse client needs. Collaborated closely with clients to define project requirements, ensuring timely delivery and high-quality execution.",
	...
	},
	{
		...
		title: "Researched and implemented Web3 technologies to develop a secure NFT marketplace, integrating Metamask authentication and IPFS. Engineered core features using Next.js, MongoDB, and TailwindCSS, including NFT minting and real-time auction systems. Led a team of three developers, coordinating workflows to ensure high code quality and timely project delivery.",
